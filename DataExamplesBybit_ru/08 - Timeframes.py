...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    from_date = dt.datetime.now() - dt.timedelta(minutes=10*60)  # берем данные за последние 5 часов
    ...
    # from_date = dt.datetime.now() - dt.timedelta(minutes=60)  # берем данные за последний 1 час
    ...
    # from_date = dt.datetime.now() - dt.timedelta(hours=24*7)  # берем данные за последнюю неделю от текущего времени
