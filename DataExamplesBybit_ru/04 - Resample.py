...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    from_date = dt.datetime.now() - dt.timedelta(minutes=60)  # берем данные за последние 5 часов
    ...
    # Добавляем данные из Bybit для проверки правильности работы Resample
