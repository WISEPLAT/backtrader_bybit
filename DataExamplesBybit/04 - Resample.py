...
if __name__ == '__main__':  # Entry point when running this script
    ...
    from_date = dt.datetime.now() - dt.timedelta(minutes=60)  # we take data for the last 10 hours
    ...
    # Adding data из Bybit для проверки правильности работы Resample
    ...
    # from_date = dt.datetime.now() - dt.timedelta(minutes=240)
    # print(from_date)
    ...
    # # Adding data from Bybit to verify the correct operation of Resample
