...
if __name__ == '__main__':  # Entry point when running this script
    ...
    # from_date = dt.datetime.now() - dt.timedelta(minutes=10*60)  # we take data for the last 10 hours
    ...
    from_date = dt.datetime.now() - dt.timedelta(minutes=60)  # we take data for the last 1 hour
    ...
    # from_date = dt.datetime.now() - dt.timedelta(hours=24*7)  # we take data for the last week from the current time
